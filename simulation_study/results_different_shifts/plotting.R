...
for(mf in sample_sizes){
  ...
  boxplot(beta_xs_s, outline=FALSE, names = sample_sizes, show.names=TRUE, xlab="Multiplying factor of average shift", ylab = "Node-specific exogenous covariate effect", 
  ...
  par(mar=c(5.5,6,4.5,1)+1, mgp=c(5,2,0))
  boxplot(beta_xs_sr, outline=FALSE, names = sample_sizes, show.names=TRUE, xlab="Multiplying factor of average shift", ylab = "Dyadic exogenous covariate effect", 
          cex.main = 2,cex.axis = 2.5, cex.lab = 2.5)
  ...
  boxplot(beta_xs_gc, outline=FALSE, names = sample_sizes, show.names=TRUE,
         xlab="Multiplying factor of average shift", ylab = "Global covariate effect", 
          cex.main = 2,cex.axis = 2.5, cex.lab = 2.5)
  ...
  par(mar=c(5.5,6,4.5,1)+1, mgp=c(5,2,0))
  boxplot(beta_xs_end, outline=FALSE, names = sample_sizes, show.names=TRUE, xlab="Multiplying factor of average shift", ylab = "Dyadic endogenous covariate effect", 
          cex.main = 2,cex.axis = 2.5, cex.lab = 2.5)
  ...
  par(mar=c(5.5,6,4.5,1)+1, mgp=c(5,2,0))
  boxplot(log(l2_norm_exp_per_mf_simulated_tp), outline=FALSE, names = sample_sizes, show.names=TRUE , xlab="Multiplying factor of average shift", ylab = "log(L2)", 
          cex.main = 2,cex.axis = 2.5, cex.lab = 2.5)
  #, ylim = c(-4.5,1)
  dev.off()
  ...
  par(mar=c(5.5,6,4.5,1)+1, mgp=c(5,2,0))
  boxplot(log(l2_norm_exp_per_mf_simulated_tp)[,-c(1)], outline=FALSE, names = sample_sizes[-c(1)], show.names=TRUE , xlab="Multiplying factor of average shift", ylab = "log(L2)", 
          cex.main = 2,cex.axis = 2.5, cex.lab = 2.5)
  #, ylim = c(-4.5,1)
  dev.off()
  ...
  for(mf in sample_sizes){
    ...
    plot(c_model_est[[1]]$model$`sort(simdat$event_time)`,c_model_est[[1]]$model$L0,type="l", 
         ...
         xlab = "Time", main = paste("mf = ",mf, sep = ""), col = "grey", lwd = 3)
